...
const copy = {
  zh: {
    ...
    profile: '经历与证据', profileSub: '背景、实践与可验证结果', hello: '我是傅文基。', bio1: '西南财经大学金融学本科生，也是独立开发者。我喜欢把看似不相干的领域接起来：用强化学习做兵棋 AI，用金融模型拆现实问题，再把过程公开成代码。', bio2: '我正在寻找一段能碰到真实产品、真实用户和硬问题的开发实习。',
    ...
    subscribeTitle: '订阅更新', subscribeDesc: '收到最新文章、项目进展与研究记录。邮件确认，不接入第三方广告系统。', emailPlaceholder: '你的邮箱', subscribe: '邮件订阅', subscribeHint: '点击后将打开邮件客户端完成确认。',
  ...
  en: {
    ...
    method: 'Practice & Method', methodSub: 'Technology is a path to an answer, not a checklist',
    profile: 'Background & Proof', profileSub: 'Experience, practice and verifiable outcomes', hello: 'I’m Fu Wenji.', bio1: 'A finance undergraduate at SWUFE and an independent developer. I connect unlikely fields: reinforcement learning for wargame AI, financial models for real questions, and open code for the process.', bio2: 'I’m looking for a development internship close to real products, real users and hard problems.',
    field: 'Field Notes', fieldSub: 'Life, travel and everything outside work', scrollGallery: 'Keep scrolling / images move left',
    ...
    subscribeTitle: 'Subscribe', subscribeDesc: 'Get new essays, project progress and research notes. Email confirmation, no ad network.', emailPlaceholder: 'Your email', subscribe: 'Subscribe by email', subscribeHint: 'Your email client will open to confirm.',
    ...
    articlesTitle: 'Writing Index', articlesLead: 'Wargames, finance, AI and macro research. Long-form writing keeps what cannot fit in a one-liner.',
    notesTitle: 'Notes Index', notesLead: 'Course material and study references, stored in a dedicated notes repository.',
