...
function Home({ openingVariant = 'v1' }) {
  ...
  return <main>
    <div className={`opening opening--${openingVariant}`} aria-hidden="true"><div className="opening-panel" /><div className="opening-panel" /><div className="opening-panel" /><div className="opening-kicker"><span>INDEPENDENT DEVELOPER</span><span>PORTFOLIO / 2026</span></div><div className="opening-cn"><span>傅文基</span></div><div className="opening-name"><span>FU</span><span>WENJI</span></div><i className="opening-rule" /><p className="opening-label"><span>FU WENJI / PORTFOLIO</span></p><strong className="opening-count">000</strong></div>
